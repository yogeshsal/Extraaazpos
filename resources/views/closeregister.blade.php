...
<style> .flex-container { display: flex; flex-direction: row; justify-content: space-between; } .flex-column { display:
  flex; flex-direction: column; } .positive-value { color: red; } table { border-collapse: collapse; width: 100%; } th,
  td { padding: 8px; text-align: left; } th { background-color: #f5f5f5; color: #646464; font-weight: 950; font-size:
  small; } tr { border-bottom: 2px solid #F5F5F5; /* Light grey border between rows */ } </style>
              ...
              <div class="flex-container">
                ...
                <div class="flex-column">
                  <h6><i class="fa fa-refresh" aria-hidden="true"></i>&nbsp; Calculated a few Seconds ago &nbsp;
                    <a href="/dailyregister"><button id="showmessage" class="btn btn-orange">Reset
                        Closing...</button></a>
                  </h6>
