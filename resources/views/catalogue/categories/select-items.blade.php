                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <form id="category-form" method="POST"
                                action="{{ route('updateItems', ['catid' => Route::current()->parameter('id')]) }}">
                                @csrf
                                <div class="card-body d-flex justify-content-between align-items-center">
                                    ...
                                    <div class="d-flex align-items-center">
                                        <div class="input-group mr-2">
                                            ...
                                            <input type="search" id="searchInput" class="form-control rounded m-1"
                                                placeholder="Tags" aria-label="Search"
                                                aria-describedby="search-addon" />
                                            <input type="search" id="searchInput" class="form-control rounded m-1"
                                                placeholder="Categories" aria-label="Search"
                                                aria-describedby="search-addon" />
                                ...
                                <table class="table table-hover">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            <td>
                                                <input value="{{$item->id}}" class="category-checkbox" type="checkbox"
                                                    name="selected_categories[]" id="category-{{$item->id}}"
                                                    @if(in_array($item->id, $ids)) checked @endif>
                                            </td>
