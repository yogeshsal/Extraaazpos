                        ...
                        <form action="{{ route('categories.update', $category->id) }}" method="POST">
                            ...
                            <div class="row form-row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="cat_handle" class="form-control"
                                            value="{{ $category->cat_handle }}">
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label for="cat_timing_group">Timing Group</label>
                                        <select name="cat_timing_group" class="form-select"
                            ...
                            <div class="row form-row">
                                <div class="form-group">
                                    ...
                                    <textarea name="cat_desc" class="form-control mt-3" id="exampleFormControlTextarea1"
                                        rows="4">{{ $category_desc }}</textarea>
                                </div>
                            </div>
                            <div class="modal-footer form-row">
                                <a href="\categories"><button type="button" class="btn btn-secondary m-2"
            ...
            <div id="tab3">
                <div class="card shadow p-3">
                    <div class="row">
                        ...
                        <div class="col-auto">
                            <a href="{{ route('categories.items', ['id' => $category->id]) }}" type="button"
                                class="btn btn-orange">Update Items</a>  
                        </div>
                    </div>
                </div>
