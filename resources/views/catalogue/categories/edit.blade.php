                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <ul class="nav nav-tabs mb-3" role="tablist">
                                <li class="nav-item ">
                                    <a class="nav-link active" data-bs-toggle="tab" href="#basicinfo" role="tab" aria-selected="false">
                                        Basic Information
                                    </a>
                                </li>
                                <li class="nav-item">
                                        ...
                                        <div class="row">
                                            <div class="col-6">
                                                <div class="mb-3">
                                                    ...
                                                    <input type="text" class="form-control" placeholder="Enter name" name="cat_name" id="compnayNameinput" value="{{ $category->cat_name }}">
                                                </div>
                                            </div><!--end col-->
                                            <div class="col-6">
                                                <div class="mb-3">
                                                    <label for="Description" class="form-label">Short Name</label>
                                                    <input type="text" class="form-control" name="cat_short_name" placeholder="Enter Description" value="{{ $category->cat_short_name }}" id="phonenumberInput">
                                                </div>
                                            </div><!--end col-->
                                            <div class="col-6">
                                                <div class="mb-3">
                                                    <label for="handle" class="form-label">Handle</label>
                                                    <input type="text" class="form-control" name="cat_handle" value="{{$category->cat_handle}}" placeholder="Enter Handle" id="address1ControlTextarea">
                                                </div>
                                            </div><!--end col-->
                                            <div class="col-6">
                                                <div class="mb-3">
                                                    <label for="cat_timing_group" class="form-label">Timing Group</label>
                                                    <select name="cat_timing_group" id="cat_timing_group" class="form-select">
                                            ...
                                            <div class="col-6">
                                                <div class="mb-3">
                                                    <label for="cat_parent_category" class="form-label">Parent Category</label>
                                                    <select name="cat_parent_category" id="cat_parent_category" class="form-select">
