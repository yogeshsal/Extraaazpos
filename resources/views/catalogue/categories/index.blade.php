                            ...
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="item_name" class="form-control my-2" required>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label for="mobile">Short Name:</label>
                                            <input type="text" name="item_short_name" class="form-control my-2" required>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="external_id" class="form-control my-2" required>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label for="timing_group">Timing Group</label><br>
                                            <select name="timing_group" class="form-control my-2">
                                ...
                                <div class="row">
                                    <div class="form-group">
                                        ...
                                        <textarea name="item_description" class="form-control my-2" id="exampleFormControlTextarea1" rows="4"></textarea>
                                    </div>
                                </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <select name="item_pos_code" id="pos_code" class="form-control my-2">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <select name="item_food_type" id="food_type" class="form-control my-2">
