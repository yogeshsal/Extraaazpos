...
<div id="content1">
    <div class="tabContainer">
        <ul class="tabs">
            <li><a src="tab1" href="javascript:void(0);" class="active">Basic Information</a>
            </li>
                    ...
                    <form action="{{ route('discounts.update', ['id' => $discount->id]) }}" method="POST">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label for="name">Applicable On:</label>
                                    <select name="applicable_on" class="form-select" aria-label="Default select example"
                                        id="selectOption">
                                        <option value="1" {{ $discount->applicable_on == 1 ? 'selected' : '' }}>
                                            Bill Sub
                                            Total Amount</option>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 mt-0">
                                ...
                                <div class="input-group mb-3">
                                    ...
                                    <input name="discount_value" type="text" class="form-control" id="basic-url"
                                        aria-describedby="basic-addon3" value="{{ $discount->discount_value }}">
                                </div>
                            </div>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                ...
                                <div class="input-group mb-3">
                                    ...
                                    <input name="max_discount_value" type="text" class="form-control" id="basic-url"
                                        aria-describedby="basic-addon3" value="{{ $discount->max_discount_value }}">
                                </div>
                            </div>
                            <div class="col-md-6">
                                <label for="basic-url" id="dynamicLabel">Minimum Bill Sub Total
                                ...
                                <div class="input-group mb-3">
                                    ...
                                    <input name="min_total_amount" type="text" class="form-control" id="basic-url"
                                        aria-describedby="basic-addon3" value="{{ $discount->min_total_amount }}">
                                </div>
                            </div>
                        ...
                        <div class="row">
                            <div class="col-md-6 mt-3">
                                <input type="checkbox" {{ $discount->auto_apply_billing_type ? 'checked' : '' }}
                                    data-toggle="toggle" id="toggleButton" data-style="ios">
                            </div>
                            <div class="col-md-6">
                                <div class="form-group" id="textboxContainer">
                            ...
                            <div class="row">
                                <div class="form-group">
                                    ...
                                    <select name="user_role" class="form-select" aria-label="Default select example">
                                        <option value="" {{ $discount->user_role ? '' : 'selected' }}>Select
                                            a role
                                        </option>
                                        <option value="All" {{ $discount->user_role == 'All' ? 'selected' : '' }}>
                                            All
                                        </option>
                                        <option value="Administrator"
                                            {{ $discount->user_role == 'Administrator' ? 'selected' : '' }}>
