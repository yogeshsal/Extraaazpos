                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <select name="applicable_on" class="form-select" aria-label="Default select example" id="selectOption">
                                                    <option value="1" {{ $discount->applicable_on == 1 ? 'selected' : '' }}>Bill
                                                        Sub
                                                        Total Amount</option>
                                                    <option value="2" {{ $discount->applicable_on == 2 ? 'selected' : '' }}>
                                                        Specific
                                                        Items</option>
                                                </select>
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <select id="discount_type" class="form-select" aria-label="Default select example">
                                                    <option value="" {{ is_null($discount->discount_type) ? 'selected' : '' }}>
                                                        Select Type</option>
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group" id="textboxContainer">
                                                ...
                                                <select name="auto_apply_billing_type" class="form-select" aria-label="Default select example" id="textBox">
                                                    <option value="1" {{ $discount->auto_apply_billing_type == 1 ? 'selected' : '' }}>
                                                        Ac Table
                                                    </option>
                                                    <option value="2" {{ $discount->auto_apply_billing_type == 2 ? 'selected' : '' }}>
                                                        Inside
                                                        Section</option>
                                                    <option value="3" {{ $discount->auto_apply_billing_type == 3 ? 'selected' : '' }}>
                                                        Pool Section
                                                    </option>
                                                    <option value="4" {{ $discount->auto_apply_billing_type == 4 ? 'selected' : '' }}>
                                                        Token
                                                    </option>
                                                    <option value="5" {{ $discount->auto_apply_billing_type == 5 ? 'selected' : '' }}>
                                                        Dine In
                                                    </option>
                                                </select>
                                            </div>
                                    ...
                                    <div class="row">
                                        <div class="form-group">
                                            ...
                                            <select name="user_role" class="form-select" aria-label="Default select example">
                                                ...
                                                <option value="All" {{ $discount->user_role == 'All' ? 'selected' : '' }}>All
                                                </option>
                                                <option value="Administrator" {{ $discount->user_role == 'Administrator' ? 'selected' : '' }}>
                                                    Administrator</option>
                                                <option value="Cashier" {{ $discount->user_role == 'Cashier' ? 'selected' : '' }}>
                                                    Cashier</option>
                                                <option value="Manager" {{ $discount->user_role == 'Manager' ? 'selected' : '' }}>
                                                    Manager</option>
                                                <option value="Online Order Supervisor" {{ $discount->user_role == 'Online Order Supervisor' ? 'selected' : '' }}>
                                                    Online Order Supervisor</option>
                                                <option value="Satellite Tracker" {{ $discount->user_role == 'Satellite Tracker' ? 'selected' : '' }}>
                                                    Satellite Tracker</option>
                                                <option value="Online Order Processor" {{ $discount->user_role == 'Online Order Processor' ? 'selected' : '' }}>
                                                    Online Order Processor</option>
                                                <option value="Billing User" {{ $discount->user_role == 'Billing User' ? 'selected' : '' }}>
                                                    Billing User
                                                </option>
                                                <option value="Captain" {{ $discount->user_role == 'Captain' ? 'selected' : '' }}>
                                                    Captain</option>
                                    ...
                                    <div class="card-body">
                                        <div class="d-flex justify-content-between">
                                            <div>
                                                ...
                                                <p class="fs-5 text-muted">Discount is applicable to only these selected items</p>
                                            </div>
                                            <div>
                                                <a type="button" class="btn btn-orange" href="{{ route('discounts.select_items', $discount->id) }}">Update
                                                    Items</a>
                                            </div>
                                        </div>
                                    </div>
