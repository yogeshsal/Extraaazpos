                                    ...
                                    <form action="{{ route('category-timing.update', $timing->id) }}" method="POST">
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="name" class="form-control my-2 my-2"
                                                        value="{{ $timing->name }}">
                                                </div>
                                        ...
                                        <div class="row ">
                                            <div class="form-group">
                                                ...
                                                <input style="height: 80px;" type="text" name="description"
                                                    class="form-control" value="{{$timing->description}}">
                                            </div>
                                        </div>
                                        <br>
                                        <div class="row ">
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="time" name="start_time" class="form-control my-2 my-2"
                                        ...
                                        <div id="dvPassport">
                                            <div class="weekDays-selector ">
                                                ...
                                                <input type="checkbox" id="chkEveryday" name="days[]" value=""
                                                ...
                                                <div id="week">
                                                    <div class="form-check form-check-inline">
                                                        <input type="checkbox" name="days[]" value="1" id="weekday-mon"
                                                            class="form-check-input weekday">
                                                        <label for="weekday-mon" class="form-check-label">MON</label>
                                                    </div>
                                                    <div class="form-check form-check-inline">
                                                        <input type="checkbox" name="days[]" value="2" id="weekday-tue"
                                                            class="form-check-input weekday">
                                                        <label for="weekday-tue" class="form-check-label">TUE</label>
                                                    </div>
                                                    <div class="form-check form-check-inline">
                                                        <input type="checkbox" name="days[]" value="3" id="weekday-wed"
                                                            class="form-check-input weekday">
                                                        <label for="weekday-wed" class="form-check-label">WED</label>
                                                    </div>
                                                    <div class="form-check form-check-inline">
                                                        <input type="checkbox" name="days[]" value="4" id="weekday-thu"
                                                            class="form-check-input weekday">
                                                        <label for="weekday-thu" class="form-check-label">THU</label>
                                                    </div>
                                                    <div class="form-check form-check-inline">
                                                        <input type="checkbox" name="days[]" value="5" id="weekday-fri"
                                                            class="form-check-input weekday">
                                                        <label for="weekday-fri" class="form-check-label">FRI</label>
                                                    </div>
                                                    <div class="form-check form-check-inline">
                                                        <input type="checkbox" name="days[]" value="6 id=" weekday-sat"
                                                            class="form-check-input weekday">
                                                        <label for="weekday-sat" class="form-check-label">SAT</label>
                                                    </div>
                                                    <div class="form-check form-check-inline">
                                                        <input type="checkbox" name="days[]" value="7" id="weekday-sun"
                                                            class="form-check-input weekday">
                                        ...
                                        <div class="modal-footer form-row">
                                            <a href="/category-timing"><button type="button"
                                        ...
                                        <div class="card-body">
                                            <div class="d-flex justify-content-between">
                                                <div>
                                                    ...
                                                    <p class="fs-5 text-muted">categories(s) are associated to this
                                                        category timing</p>
                                                </div>
                                                <div>
                                                    <a type="button" class="btn btn-orange"
                                                        href="{{ route('category-timing.select_category', $timing->id) }}">Update
                                                        Categories</a>
                                                </div>
                                            </div>
                                        </div>
