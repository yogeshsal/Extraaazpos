...
<div class="main-content">
    ...
    <div class="page-content">
            ...
            <div class="card-body d-flex justify-content-between align-items-center">
                ...
                <div class="d-flex align-items-center">
                    <div class="input-group mr-2">
                        ...
                        <button type="button" class="btn btn-sm btn-orange m-1" data-bs-toggle="modal" data-bs-target="#modifierModal">
                            <i class="bi bi-plus-lg fw-bolder text-white"></i> New Modifier</button>
                    </div>
        ...
        <!-- Modal -->
        <div class="modal fade modal-lg" id="modifierModal" tabindex="-1" role="dialog" aria-labelledby="modifierModalLabel" aria-hidden="true">
            <div class="modal-dialog modal-lg" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h4 class="modal-title" id="modifierModalLabel">New Modifier</h4>
                            ...
                            <form action="{{ route('modifiergroups.store') }}" method="POST">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6 mt-4">
                                        <div class="form-group">
                                            ...
                                            <select name="modifier_group_type" id="modifier_group_type" class="form-control my-2">
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="item_default_sell_price" class="form-control my-2">
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="form-group">
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="modifier_group_name" class="form-control my-2">
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label for="">Short Name</label>
                                            <input type="text" name="modifier_group_short_name" class="form-control my-2">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="modifier_group_handle" class="form-control my-2">
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
                                ...
                                <div class="row">
                                    <div class="form-group">
                                        ...
                                        <textarea name="modifier_group_desc" class="form-control my-2" id="exampleFormControlTextarea1" rows="4"></textarea>
                                    </div>
                                </div>
