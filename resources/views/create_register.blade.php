    ...
    <div class="page-content">
        <div class="card shadow">
            <div class="card-body d-flex justify-content-between align-items-center">
                <div>
                    <h3 class="p-0">Opening register for {{ auth()->user()->name }} at
                        {{isset($locationname)? $locationname : ''}}
                    </h3>

                </div>
            </div>
            <div class="container"> @csrf <form action="{{ route('storeRegister') }}" method="post">
                    <div class="row">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="p-4">
                                    ...
                                    <button type="button" class="btn btn-outline-primary ml-2">Choose Another
                                        Register</button>
