                                                        ...
                                                        <div id="balconyDiv">
                                                            <li onclick="showBalcony()">
                                                                <div class="circle-container">
                                                                    @for ($i = 1; $i <= $bal; $i++)
                                                                        <div class="circle" id="bal-{{ $i }}"
                                                                            onclick="showCircleDetails(this)">
                                                                            <span
                                                                                class="circle-number">{{ $i }}</span>
                                                                        </div>
                                                                    @endfor
                                                            </li>
                                                        </div>
                                        ...
                                        <div class="modal-body">
                                            <form action="">
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    <input type="text" class="form-control" id="bill_note"
                                                        name="bill_note" placeholder="Bill Note">
                                                </div>
                                                <div class="mb-3">
                                    ...
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            ...
                                            <div class="hstack gap-2 d-grid flex-wrap">
                                                ...
                                                <button type="button"
                                                    class="btn btn-outline-light custom-toggle text-start"
