                        ...
                        <div class="card shadow-lg p-2 p-2">
                            <div class="card-body">
                                ...
                                <p class="card-text">
                                    ...
                                    <span class=" text-success fw-bolder float-end"><i class="bi bi-caret-up-fill"></i> +89%</span>
                                </p>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="card shadow-lg p-2">
                            <div class="card-body">
                                <h5>Today's Net Sales</h4>
                                    ...
                                    <span class=" text-success fw-bolder float-end"><i class="bi bi-caret-up-fill"></i> +59%</span>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-3">
                        <div class="card shadow-lg p-2">
                            <div class="card-body">
                                <h5>Today's Credit Sales</h4>
                                    <span id="refundValue">50,0998</span>
                                    <span class=" text-danger fw-bolder float-end"><i class="bi bi-caret-down-fill"></i> -88%</span>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="card shadow-lg p-2">
                            <div class="card-body">
                                <h5>Products sold this month</h4>
                                    <span id="refundValue">50,0998</span>
                                    <span class=" text-success fw-bolder float-end"><i class="bi bi-caret-up-fill"></i> +9%</span>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="card shadow-lg p-2">
                            <div class="card-body">
                                <h5>Total Inventory Cost</h4>
                                    <span id="refundValue">50,0998</span>
                                    <span class=" text-danger fw-bolder float-end"><i class="bi bi-caret-down-fill"></i> -29%</span>
                            </div>
                        </div>
                    </div>
                </div>
