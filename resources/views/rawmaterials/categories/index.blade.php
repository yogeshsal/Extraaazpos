...
<div class="card shadow">
    ...
    <div>
            <h3>Categories</h3>
            <p>Categories used for Raw Materials</p>
        </div>
        ...
        <div class="d-flex align-items-center">
            ...
            <div class="input-group mr-2">
                ...
                <a href="" class="btn btn-orange m-1" data-toggle="modal" data-target="#add_item_modal">+ Add Category</a>
            </div>        
        </div>       
    </div> 
    ...
    <thead>
        <tr > 
            ...
            <th class="grey-background">MATARIAL ITEM</th>
