    ...
    <div class="page-content">
        ...
        <div class="card shadow">
            <div class="card-body d-flex justify-content-between align-items-center">
                <div>
                    <h3>Locations</h3>
                    <p>You can manage your online locations from here</P>
                </div>
                <div class="d-flex align-items-center">
                    <div class="input-group mr-2">
                        ...
                        <a href="" class="btn btn-orange m-1" data-toggle="modal" data-target="#add_item_modal">+ New</a>
                    </div>
                </div>
            </div>
            <div class="card shadow mt-4">
                <div class="card-header">
                    <ul class="nav nav-tabs" id="myTab" role="tablist">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" id="pos-tab" data-toggle="tab" href="#pos" role="tab" aria-controls="pos" aria-selected="false">Point of Sale</a>
                        </li>
                    </ul>
                </div>
