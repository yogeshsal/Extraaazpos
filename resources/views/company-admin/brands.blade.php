    ...
    <div class="page-content">
        ...
        <div class="card shadow">
            <div class="card-body d-flex justify-content-between align-items-center">
                <div>
                    <h3>Brands</h3>
                    <p class="text-muted">Manage all your cloud kitchen brands from here.</p>
                </div>
                ...
                <div class="d-flex align-items-center">
                    <div class="input-group mr-2">
                        ...
                        <a href="" class="btn btn-orange m-1" data-toggle="modal" data-target="#add_item_modal"><i class="bi bi-plus-lg fw-bolder text-white"></i> Add Brands</a>
                    </div>
                </div>
            </div>
