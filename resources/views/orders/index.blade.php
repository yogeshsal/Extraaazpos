    ...
    function fetchCartItems() {
        $.ajax({
            ...
            success: function(response) {
                ...
                selectedItems =
                cartItems; // Store the retrieved cart items in the selectedItems array
    ...
    function saveToDatabase(selectedItem) {
        ...
        fetch('/save-to-cart', {
                ...
                body: JSON.stringify({
                    ...
                    customer_id: localStorage.getItem(
                    'selectedCustomer'), // Retrieve customer ID from localStorage
                    product_name: selectedItem.name,
                    unit_price: selectedItem.price,
                    quantity: selectedItem.quantity,
                    product_total: selectedItem.price * selectedItem.quantity,
